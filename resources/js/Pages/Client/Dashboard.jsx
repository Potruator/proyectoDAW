                        ...
                        <div className='grid gap-6'>
                            {offers.map((item) => (
                                <Link
                                    ...
                                    className='group block bg-gray-900 border-gray-800 rounded-2xl p-5 shadow-sm border hover:shadow-md active:shadow-md active:border-amber-200 hover:border-amber-200 transition-all'
                                >
                                    <div className='flex justify-between items-start'>
                                        <div className='flex-1'>
                                            <h3 className='text-lg font-bold group-hover:text-amber-400 group-active:text-amber-400 transition-colors'>
                                                {item.title}
                                            </h3>
                                        ...
                                        <div className='ml-4 p-3 rounded-xl group-hover:bg-amber-100 group-active:bg-amber-100 transition-colors'>
